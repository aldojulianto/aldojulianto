...
$data=mysqli_query($koneksi,"select a.id_barcode as id, a.nama_barang as nama,sum((a.harga_jual-a.harga_beli)*b.jumlah) as untung from barang a join transaksi b on a.id_barcode=b.id_barcode where month(b.tanggal_input)=month(curdate()) group by a.nama_barang order by untung desc");
        ...
        <table id="example1" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo  "Rp " . number_format($d["untung"],2,',','.'); ?></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
