<?php
    ...
    $data = mysqli_query($koneksi,"select * from biaya");   //where month(tgl_invoice)=month(curdate()) and year(tgl_invoice)=year(curdate())     
	...
	<div class="container-fluid">
		...
		<table id="example1" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					<th><?php echo $d["id_biaya"]; ?></th>
					<td><?php echo $d["keterangan"]; ?></td>
					<td><?php echo $d["biaya"]; ?></td>
                    <td><?php echo $d["tanggal"]; ?></td>
					<td>
						<a class="btn btn-danger alert_notif" href="hapusbiaya.php?baris=<?php echo $d['id_biaya'] ?>" role="button">X</a>
					</td>
				</tr>
				<?php } ?>
			</tbody>
	...
	<script>
		...
		<?php 
			if(isset($_POST['submit'])) {
				...
				mysqli_query($koneksi,"INSERT INTO biaya (keterangan, biaya, tanggal) VALUES ('$keterangan', '$biaya', current_timestamp());");
				echo "<script>Swal.fire('Biaya Berhasil Ditambahkan!', '', 'success')</script>";
